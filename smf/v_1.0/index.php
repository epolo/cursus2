...
/*  START   EXPROFESSO INTEGRATION ADD ONCE     */

if (isset($_GET['exprofesso-install']))
{
	require_once($sourcedir . '/exprofesso/install.php');
}

/*  FINISH   EXPROFESSO INTEGRATION ADD ONCE     */
